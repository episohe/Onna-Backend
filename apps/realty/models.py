...
class Realty(CoreModel):
    ...
    transaction_type = models.IntegerField(verbose_name="거래 종류", choices=TRANSACTION_CHOICES, null=True)
    property_type = models.IntegerField(verbose_name="부동산 종류", choices=PROPERTY_CHOICES, null=True)
