...
class RealtySerializer(serializers.ModelSerializer):
    ...
    phone_agency = serializers.ChoiceField(choices=Realty.PHONE_AGENCY_CHOICES)
    phone_agency_name: str = serializers.CharField(read_only=True)
    transaction_type = serializers.ChoiceField(choices=Realty.TRANSACTION_CHOICES)
    property_type = serializers.ChoiceField(choices=Realty.PROPERTY_CHOICES)
